    ...
    private static void ProcessSynopticTable(Workbook workbook)
    {
        ...
        try
        {
            ...
            foreach (var overallFrequencyDataRow in overallFrequencyDataRows)
            {
                var newRow = synopticTable.NewRow();
                newRow["Macrocategoria"] = "Valutazione";
                newRow["Categoria"] = synopticTableType == SynopticTableType.GradimentoComplessivo ? "Gradimento complessivo" : "Soddisfazione complessiva";
            ...
            synopticTable.WriteSynopticTableToWorksheet(
                destinationSheet,
                synopticTableType == SynopticTableType.GradimentoComplessivo ? "Gradimento complessivo" : "Soddisfazione complessiva",
                synopticTableType);
